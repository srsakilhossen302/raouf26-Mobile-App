...
class AppTranslations extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
    'en_US': {
      ...
      'now_verified': 'You\'re Now Verified!',
      'account_verified_desc': 'Your account has been successfully verified.',
      'continue': 'Continue',
      'documents_verification': 'Documents Verification',
      'not_verified': 'Not Verified',
      'get_verified': 'Get Verified',
      'why_verify_identity': 'Why Verify Your Identity?',
      'build_trust': 'Build Trust',
      'more_opportunities': 'More Opportunities',
      'identity_documents': 'Identity Documents',
      'passport': 'Passport',
      'cin_id_card': 'CIN (ID Card)',
      ...
      'position_document_frame': 'Position the document within the frame',
      'scan_passport': 'Scan Passport',
      'scan_cin_front': 'Scan CIN (Front of Document)',
      ...
      'facial_verification_desc': 'Required to confirm your identity matches your documents.',
      'take_a_selfie': 'Take a Selfie',
      'selfie_with_document': 'Selfie with Document',
      'identity_documents_desc': 'Upload at least one identity document.',
      'transporter_documents_desc': 'Required for professional transporter activity.',
      'not_verified_desc': 'Upload your document to verify your identity and build trust with other users.',
      'build_trust_desc': 'Verified users are more trusted by the community.',
      'more_opportunities_desc': 'Get priority in matching with transporters and travelers.',
      'selfie_tips': 'Selfie Tips',
      'neutral_expression': 'Maintain a neutral expression',
      'face_visible': 'Ensure your face is clearly visible',
      'no_glasses_hats': 'Avoid wearing glasses or hats',
      'face_camera_directly': 'Face the camera directly',
      'good_lighting': 'Ensure good lighting',
      'flat_surface': 'Place document on flat surface',
      'corners_visible': 'All corners must be visible',
      'text_readable': 'Text must be readable',
      'tap_to_scan': 'Tap to Scan',
      'no_doc_scanned': 'No document scanned yet',
      'take_selfie': 'Take Selfie',
      'take_selfie_with_doc': 'Take Selfie with Document',
      ...
      'upload_pickup_proof': 'Upload Pickup Proof',
      'take_photo_or_upload': 'Take a photo or upload',
      'package_condition': 'Package Condition',
      'package_good': 'Package in good condition',
      'minor_damage': 'Minor visible damage',
      'damaged_parcel': 'Damaged parcel or packaging',
      'add_note': 'Add Note',
      ...
      'signature': 'Signature',
      'new_delivery_requests': 'You have 2 new delivery requests',
    ...
    'fr_FR': {
      ...
      'now_verified': 'Vous Êtes Maintenant Vérifié !',
      'account_verified_desc': 'Votre compte a été vérifié avec succès.',
      'continue': 'Continuer',
      'documents_verification': 'Vérification des Documents',
      'not_verified': 'Non Vérifié',
      'get_verified': 'Se Faire Vérifier',
      'why_verify_identity': 'Pourquoi Vérifier Votre Identité ?',
      'build_trust': 'Instaurer la Confiance',
      'more_opportunities': 'Plus d\'Opportunités',
      'identity_documents': 'Documents d\'Identité',
      'passport': 'Passeport',
      'cin_id_card': 'CIN (Carte d\'Identité)',
      'driving_license': 'Permis de Conduire',
      'transporter_documents': 'Documents de Transporteur',
      'vehicle_registration': 'Carte Grise',
      'residence_certificate': 'Certificat de Résidence',
      'verification_status': 'État de la Vérification',
      'verification_progress': 'Progrès de la Vérification',
      'verified_information': 'Informations Vérifiées',
      'scanning_tips': 'Conseils de Numérisation',
      'scan_document': 'Numériser le Document',
      'position_document_frame': 'Positionnez le document dans le cadre',
      'scan_passport': 'Numériser le Passeport',
      'scan_cin_front': 'Numériser CIN (Recto)',
      ...
      'facial_verification_desc': 'Requis pour confirmer que votre identité correspond à vos documents.',
      'take_a_selfie': 'Prendre un selfie',
      'selfie_with_document': 'Selfie avec document',
      'identity_documents_desc': 'Téléchargez au moins un document d\'identité.',
      'transporter_documents_desc': 'Requis pour l\'activité de transporteur professionnel.',
      'not_verified_desc': 'Téléchargez votre document pour vérifier votre identité et établir la confiance avec les autres utilisateurs.',
      'build_trust_desc': 'Les utilisateurs vérifiés sont plus fiables pour la communauté.',
      'more_opportunities_desc': 'Obtenez la priorité dans la mise en correspondance avec les transporteurs et les voyageurs.',
      'selfie_tips': 'Conseils pour les selfies',
      'neutral_expression': 'Gardez une expression neutre',
      'face_visible': 'Assurez-vous que votre visage est clairement visible',
      'no_glasses_hats': 'Évitez de porter des lunettes ou des chapeaux',
      'face_camera_directly': 'Faites face directement à l\'appareil photo',
      'good_lighting': 'Assurez un bon éclairage',
      'flat_surface': 'Placez le document sur une surface plane',
      'corners_visible': 'Tous les coins doivent être visibles',
      'text_readable': 'Le texte doit être lisible',
      'tap_to_scan': 'Appuyez pour numériser',
      'no_doc_scanned': 'Aucun document numérisé pour le moment',
      'take_selfie': 'Prendre un selfie',
      'take_selfie_with_doc': 'Prendre un selfie avec document',
      ...
      'pickup_status': 'Ramassage',
      'drop_off': 'Dépôt',
      'date': 'Date',
      'price': 'Prix',
      'package_size': 'Taille du colis',
      'status': 'Statut',
      'open_full_map': 'Ouvrir la carte complète',
      'pickup_confirmation': 'Confirmation de ramassage',
      'verify_parcel':
          'Vérifiez le colis et notez son état avant de confirmer le ramassage.',
      'upload_pickup_proof': 'Télécharger la preuve de ramassage',
      'take_photo_or_upload': 'Prendre une photo ou télécharger',
      'package_condition': 'État du colis',
      'package_good': 'Colis en bon état',
      'minor_damage': 'Dommages visibles mineurs',
      'damaged_parcel': 'Colis ou emballage endommagé',
      ...
      'upload_delivery_proof': 'Télécharger la preuve de livraison',
      'recipient_name': 'Nom du destinataire',
      'enter_recipient_name': 'Entrez le nom complet du destinataire',
      'signature': 'Signature',
      'new_delivery_requests': 'Vous avez 2 nouvelles demandes de livraison',
    ...
    'ar_AR': {
      ...
      'now_verified': 'لقد تم التحقق منك الآن!',
      'account_verified_desc': 'لقد تم التحقق من حسابك بنجاح.',
      'continue': 'متابعة',
      'documents_verification': 'التحقق من الوثائق',
      'not_verified': 'غير موثق',
      'get_verified': 'توثيق الحساب',
      'why_verify_identity': 'لماذا توثق هويتك؟',
      'build_trust': 'بناء الثقة',
      'more_opportunities': 'المزيد من الفرص',
      'identity_documents': 'وثائق الهوية',
      'passport': 'جواز السفر',
      'cin_id_card': 'بطاقة التعريف الوطنية',
      'driving_license': 'رخصة السياقة',
      'transporter_documents': 'وثائق الناقل',
      'vehicle_registration': 'البطاقة الرمادية',
      'residence_certificate': 'شهادة الإقامة',
      'verification_status': 'حالة التحقق',
      'verification_progress': 'تقدم التحقق',
      'verified_information': 'المعلومات الموثقة',
      'scanning_tips': 'نصائح المسح الضوئي',
      'scan_document': 'مسح الوثيقة',
      'position_document_frame': 'ضع الوثيقة داخل الإطار',
      'scan_passport': 'مسح جواز السفر',
      'scan_cin_front': 'مسح بطاقة التعريف (الوجه)',
      ...
      'facial_verification_desc': 'مطلوب للتأكد من مطابقة هويتك لمستنداتك.',
      'take_a_selfie': 'التقاط صورة سيلفي',
      'selfie_with_document': 'سيلفي مع مستند',
      'identity_documents_desc': 'قم بتحميل وثيقة هوية واحدة على الأقل.',
      'transporter_documents_desc': 'مطلوب لنشاط الناقل المهني.',
      'not_verified_desc': 'قم بتحميل مستندك للتحقق من هويتك وبناء الثقة مع المستخدمين الآخرين.',
      'build_trust_desc': 'المستخدمون الموثقون أكثر ثقة من قبل المجتمع.',
      'more_opportunities_desc': 'احصل على الأولوية في المطابقة مع الناقلين والمسافرين.',
      'selfie_tips': 'نصائح السيلفي',
      'neutral_expression': 'حافظ على تعبير وجه محايد',
      'face_visible': 'تأكد من أن وجهك مرئي بوضوح',
      'no_glasses_hats': 'تجنب ارتداء النظارات أو القبعات',
      'face_camera_directly': 'واجه الكاميرا مباشرة',
      'good_lighting': 'تأكد من وجود إضاءة جيدة',
      'flat_surface': 'ضع المستند على سطح مستو',
      'corners_visible': 'يجب أن تكون جميع الزوايا مرئية',
      'text_readable': 'يجب أن يكون النص مقروءاً',
      'tap_to_scan': 'اضغط للمسح الضوئي',
      'no_doc_scanned': 'لم يتم مسح أي مستند بعد',
      'take_selfie': 'التقاط صورة سيلفي',
      'take_selfie_with_doc': 'التقاط سيلفي مع مستند',
      ...
      'pickup_status': 'استلام',
      'drop_off': 'تسليم',
      'date': 'التاريخ',
      'price': 'السعر',
      'package_size': 'حجم الطرد',
      'status': 'الحالة',
      'open_full_map': 'فتح الخريطة كاملة',
      'pickup_confirmation': 'تأكيد الاستلام',
      'verify_parcel': 'تحقق من الطرد وسجل حالته قبل تأكيد الاستلام.',
      'upload_pickup_proof': 'تحميل إثبات الاستلام',
      'take_photo_or_upload': 'التقط صورة أو قم بالتحميل',
      'package_condition': 'حالة الطرد',
      'package_good': 'الطرد بحالة جيدة',
      'minor_damage': 'أضرار مرئية طفيفة',
      'damaged_parcel': 'الطرد أو التغليف تالف',
      'add_note': 'أضف ملاحظة',
      ...
      'confirm_delivery_q':
          'هل أنت متأكد من أنك تريد تمييز هذا الطرد على أنه تم تسليمه؟',
      'upload_delivery_proof': 'تحميل إثبات التسليم',
      'recipient_name': 'اسم المستلم',
      'enter_recipient_name': 'أدخل الاسم الكامل للمستلم',
      'signature': 'التوقيع',
      'new_delivery_requests': 'لديك 2 طلبات تسليم جديدة',
