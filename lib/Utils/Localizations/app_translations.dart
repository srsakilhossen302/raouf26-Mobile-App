...
class AppTranslations extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
    'en_US': {
      ...
      'verify_parcel': 'Verify the parcel and record its condition before confirming pickup.',
      ...
      'confirm_delivery_q': 'Are you sure you want to mark this package as delivered?',
    ...
    'fr_FR': {
      ...
      'verify_parcel': 'Vérifiez le colis et notez son état avant de confirmer le ramassage.',
      ...
      'confirm_delivery_q': 'Êtes-vous sûr de vouloir marquer ce colis comme livré?',
    ...
    'ar_AR': {
      ...
      'confirm_delivery_q': 'هل أنت متأكد من أنك تريد تمييز هذا الطرد على أنه تم تسليمه؟',
