...
class AppTranslations extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
    'en_US': {
      ...
      'switching_to_transporter': 'Switching to Transporter',
      'switching_to_traveler': 'Switching to Traveler',
      ...
      'payout_methods': 'Payout Destinations',
    ...
    'fr_FR': {
      ...
      'switching_to_transporter': 'Passage au transporteur',
      'switching_to_traveler': 'Passage au voyageur',
      ...
      'payout_methods': 'Destinations de Versement',
      ...
      'deposit_methods': 'Ajouter de l\'argent',
      'personal': 'Personnel',
      'business': 'Entreprise',
      ...
      'facial_verification_desc':
          'Requis pour confirmer que votre identité correspond à vos documents.',
      'take_a_selfie': 'Prendre un selfie',
      'selfie_with_document': 'Selfie avec document',
      'identity_documents_desc':
          'Téléchargez au moins un document d\'identité.',
      'transporter_documents_desc':
          'Requis pour l\'activité de transporteur professionnel.',
      'not_verified_desc':
          'Téléchargez votre document pour vérifier votre identité et établir la confiance avec les autres utilisateurs.',
      'build_trust_desc':
          'Les utilisateurs vérifiés sont plus fiables pour la communauté.',
      'more_opportunities_desc':
          'Obtenez la priorité dans la mise en correspondance avec les transporteurs et les voyageurs.',
    ...
    'ar_AR': {
      ...
      'switching_to_transporter': 'جاري التبديل إلى ناقل...',
      'switching_to_traveler': 'جاري التبديل إلى مسافر...',
      ...
      'not_verified_desc':
          'قم بتحميل مستندك للتحقق من هويتك وبناء الثقة مع المستخدمين الآخرين.',
      'build_trust_desc': 'المستخدمون الموثقون أكثر ثقة من قبل المجتمع.',
      'more_opportunities_desc':
          'احصل على الأولوية في المطابقة مع الناقلين والمسافرين.',
