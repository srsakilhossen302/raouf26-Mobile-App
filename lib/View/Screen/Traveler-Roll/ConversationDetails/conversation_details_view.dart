...
class ConversationDetailsView extends GetView<ConversationDetailsController> {
        ...
        child: Column(
          ...
          children: [
            ...
            _buildSectionCard(
              isDarkMode,
              child: InkWell(
                onTap: () => controller.navigateToTransporterProfile(),
                child: Row(
                  children: [
                    CircleAvatar(
                      radius: 25.r,
              ...
              child: Column(
                children: [
                  _actionRow(
                    AppIcons.markUnread,
                    "Mark as Unread",
                    () => controller.onActionTap("Mark as Unread"),
                    isDarkMode,
                  ),
                  _actionDivider(),
                  _actionRow(
                    AppIcons.star,
                    "Star Conversation",
                    () => controller.onActionTap("Star Conversation"),
                    isDarkMode,
                  ),
                  _actionDivider(),
                  _actionRow(
                    ...
                    () => controller.onActionTap("Archive Conversation"),
                    isDarkMode,
                  ),
                  _actionDivider(),
                  _actionRow(
                    AppIcons.mute,
                    "Mute Conversation",
                    () => controller.onActionTap("Mute Conversation"),
                    isDarkMode,
                  ),
                  _actionDivider(),
                  _actionRow(
            ...
            _buildSectionCard(
              ...
              child: _actionRow(
                ...
                () => controller.onActionTap("Help Center"),
                isDarkMode,
                showArrow: true,
              ),
            ),
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            _noticeBulletText(
                              "We may review messages to ensure safety, provide support, and improve our services. ",
                              "Learn more",
                              isDarkMode,
                            ),
                            SizedBox(height: 12.h),
                            _noticeBulletText(
                              "You can manage how your message data is processed, including for certain automated features. ",
                              "Learn more",
                              isDarkMode,
                            ),
                          ],
  ...
  Widget _noticeBulletText(String text, String link, bool isDarkMode) {
    return Row(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(
